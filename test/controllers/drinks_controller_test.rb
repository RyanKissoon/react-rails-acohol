...
class DrinksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drink" do
    assert_difference("Drink.count") do
      post drinks_url, params: { drink: { brand: @drink.brand, country: @drink.country, quantity: @drink.quantity, style: @drink.style } }
    end
  ...
  test "should update drink" do
    patch drink_url(@drink), params: { drink: { brand: @drink.brand, country: @drink.country, quantity: @drink.quantity, style: @drink.style } }
